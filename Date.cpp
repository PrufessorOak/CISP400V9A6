...
// Assignment #: A6
// PURPOSE : To show my understanding of member functions prototyped in Date.h
...
// << print operator overload, display a Complex object in the form: (a, b)
...
int Date::checkDay(int testDay) const
{
	...
	if ((testDay > 0) && (testDay <= daysPerMonth[month])) { // if proper days in month pass the date back
		return testDay;
	}
	else
	{
